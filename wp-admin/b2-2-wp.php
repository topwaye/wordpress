...
if (!$got_links) {
	...
	$links = mysqli_query( $wpdb->dbh,"INSERT INTO $tablelinks VALUES ('', 'http://wordpress.org', 'WordPress', '', '', 1, '', 'Y', 1, 0, '1970-01-01 00:00:00', '');");
	$links = mysqli_query( $wpdb->dbh,"INSERT INTO $tablelinks VALUES ('', 'http://cafelog.com', 'b2', '', '', 1, '', 'Y', 1, 0, '1970-01-01 00:00:00', '');");
	$links = mysqli_query( $wpdb->dbh,"INSERT INTO $tablelinks VALUES ('', 'http://photomatt.net', 'Matt', '', '', 1, '', 'Y', 1, 0, '1970-01-01 00:00:00', '');");
	$links = mysqli_query( $wpdb->dbh,"INSERT INTO $tablelinks VALUES ('', 'http://zed1.com/b2/', 'Mike', '', '', 1, '', 'Y', 1, 0, '1970-01-01 00:00:00', '');");
    ...
    if ($q != false) {
        ...
        $query = "ALTER TABLE $tablelinks ADD COLUMN link_updated DATETIME NOT NULL DEFAULT '1970-01-01 00:00:00'";
