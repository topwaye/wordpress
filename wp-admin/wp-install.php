...
if (!$got_links) {
	...
	$links = mysqli_query( $wpdb->dbh, "INSERT INTO $tablelinks VALUES (0, 'http://wordpress.org', 'WordPress', '', '', 1, '', 'Y', 1, 0, '1970-01-01 00:00:00', '');");
	$links = mysqli_query( $wpdb->dbh, "INSERT INTO $tablelinks VALUES (0, 'http://cafelog.com', 'b2', '', '', 1, '', 'Y', 1, 0, '1970-01-01 00:00:00', '');");
	$links = mysqli_query( $wpdb->dbh, "INSERT INTO $tablelinks VALUES (0, 'http://photomatt.net', 'Matt', '', '', 1, '', 'Y', 1, 0, '1970-01-01 00:00:00', '');");
	$links = mysqli_query( $wpdb->dbh, "INSERT INTO $tablelinks VALUES (0, 'http://zed1.com/b2/', 'Mike', '', '', 1, '', 'Y', 1, 0, '1970-01-01 00:00:00', '');");
...
CREATE TABLE $tableusers (
  ...
  dateYMDhour datetime NOT NULL default '1970-01-01 00:00:00',
...
$query = "INSERT INTO $tableusers (ID, user_login, user_pass, user_firstname, user_lastname, user_nickname, user_icq, user_email, user_url, user_ip, user_domain, user_browser, dateYMDhour, user_level, user_aim, user_msn, user_yim, user_idmode) VALUES ( '1', 'admin', '$random_password', '', '', 'admin', '', '$admin_email', '', '127.0.0.1', '127.0.0.1', '', '1970-01-01 00:00:00', '10', '', '', '', 'nickname')";
$q = $wpdb->query($query);
